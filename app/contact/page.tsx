      ...
      <section className="bg-gradient-to-br from-primary to-primary-light text-white py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 flex items-center justify-center text-white">
            ...
            <p className="text-xl leading-relaxed text-white/95">
              ...
              and every step forward matters. Whether you&apos;re a professional seeking guidance on CE courses, 
          ...
          <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-6 mt-12">
                ...
                <div className="text-center p-6 bg-gradient-to-br from-secondary/5 to-secondary/10 rounded-xl hover:shadow-lg transition-all duration-300">
                  ...
                  <a 
                    ...
                    className="text-secondary hover:text-secondary-dark transition font-medium"
                  >
                    (346) 298-2988
                  </a>
                  <p className="text-sm text-text-primary mt-1">Monday-Friday, 9AM-6PM CST</p>
                </div>
              </div>
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="ceu-courses">CE Courses Information</option>
                ...
                <div className="text-center">
                  <button
                    type="submit"
                    className="bg-action hover:bg-action-dark text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 transform hover:scale-105 inline-flex items-center"
                  >
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-12">
              <div className="bg-gradient-to-br from-primary/5 to-primary/10 rounded-xl p-6">
                <h3 className="font-bold text-xl mb-3 text-text-primary">Office Hours</h3>
              ...
              <div className="bg-gradient-to-br from-secondary/5 to-secondary/10 rounded-xl p-6">
                <h3 className="font-bold text-xl mb-3 text-text-primary">Response Time</h3>
            ...
            <div className="mt-12 text-center">
              <h3 className="font-bold text-xl mb-4 text-text-primary">Quick Links</h3>

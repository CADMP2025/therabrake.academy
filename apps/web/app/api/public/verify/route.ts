...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    try {
      ...
      hash = Buffer.from(new Uint8Array(buf)).toString('hex')
    } catch {}
  ...
  if (!success) return NextResponse.json(payload, { status: 404 })
